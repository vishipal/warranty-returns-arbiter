---
description: Use when working with RocketRide pipelines, apps, SDK, components, or configuration
globs: ['**/*.pipe', '**/pipeline*.json', '**/*rocketride*', '**/*.rrapp', 'apps/**', 'nodes/**', 'pipelines/**', '.rocketride/**']
---
